<template>
  <div class="join-page">
    <div class="container-756">
      <div class="section-form" v-if="step == 1">
        ...
        >
          ...
          <el-form-item label="微信号" prop="wx_account" :show-message="false">
            <el-input
              class="w-576"
          ...
          <el-form-item label="工作状态" prop="identity" :show-message="false">
            <el-select
              class="w-576"
          ...
          <el-form-item label="院系/专业" prop="college" :show-message="false">
            <el-input
              class="w-576"
      ...
      <div class="section-join" v-if="step == 2">
        ...
        <div class="join-qrcode">
          <img src="~images/task/join-qrcode.png" alt="" class="qrcode__img" />
        </div>
      ...
      <div class="section-work" v-if="step == 3">
        ...
        <div class="section-button-wrap">
          <div class="section-button" @click="handleChangeStep(false)">
            返回广场
          </div>
        </div>
      </div>
